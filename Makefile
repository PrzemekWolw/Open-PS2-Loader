...
ifeq ($(PADEMU),1)
  IOP_OBJS += pademu.o btstack.o ds3usb.o ds4usb.o xbox360usb.o xboxoneusb.o xboxseriesusb.o \
...
clean:	download_lwNBD
	...
	$(MAKE) -C modules/pademu/xboxseriesusb clean
...
modules/pademu/xboxseriesusb/xboxseriesusb.irx: modules/pademu/xboxseriesusb
	$(MAKE) -C $<

$(EE_ASM_DIR)xboxseriesusb.s: modules/pademu/xboxseriesusb/xboxseriesusb.irx
	$(BIN2S) $< $@ xboxseriesusb_irx
